...
- tmp/LocAgent/README.md and AGENTS.md — commands, datasets, env vars, and model support
- tmp/LocAgent/AGENTS.md — architecture summary and common commands
- tmp/claude-agent-sdk/claude-code-sdk-demos/email-agent/README.md and AGENTS.md — demo setup, Bun usage, test scripts
